...
public class DestinatarioController implements Serializable {
    ...
    @EJB
    private Facades.DestinatarioFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("DestinatarioCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("DestinatarioUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("DestinatarioDeleted"));
        if (!JsfUtil.isValidationFailed()) {
